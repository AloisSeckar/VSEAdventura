...
import cz.alois_seckar.vseadventrura.eu.pedu.adv16s_fw.game_gui.IGSMFactoryProductG;
 ...
 * @version 2016-Summer
 */
public interface IAuthorDemo extends IGSMFactoryProductG
{
//== STATIC CONSTANTS ==========================================================
    ...
    Class<DemoGSMFactory> FACTORY_CLASS = DemoGSMFactory.class;
...
//== ABSTRACT GETTERS AND SETTERS ==============================================
     ...
     */
    @Override
    default public Class<DemoGSMFactory> getFactoryClass()
    {
