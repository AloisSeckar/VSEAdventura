...
//== CONSTRUCTORS AND FACTORY METHODS ==========================================
     ...
     *              containing neither leading nor trailing whitespaces
...
//== PRIVATE AND AUXILIARY INSTANCE METHODS ====================================
     ...
     *              must contain neither leading nor trailing spaces.
     * @param //type  Type of scenario
     * @param //scenarioManager Destination scenario manager (the manager
     *              for which the scenario is created and which will manage it)
     * @param steps Individual scenario steps; the command in the zeroth item
            ...
            throws IllegalArgumentException
    {
        ...
        ERROR:
        {
            ...
            if (! name.trim().equals(name)) {
                error = "Scenario name contains leading and/or trailing spaces";
                break ERROR;
            }
            if ("".equals(name)) {
    ...
    private String testItem(ScenarioStep step)
    {
        ...
        boolean correct =
            ((message = testSubItem("the bag content",
                                        step.bag      )).isEmpty())  &&
            ((message = testSubItem("the current space neighbors",
                                        step.neighbors)).isEmpty())  &&
            ((message = testSubItem("the current space items",
                                        step.items    )).isEmpty());
        if (! correct) {
    ...
    {
        Optional<String> obtained = Stream.of(vector)
            .map(s ->
