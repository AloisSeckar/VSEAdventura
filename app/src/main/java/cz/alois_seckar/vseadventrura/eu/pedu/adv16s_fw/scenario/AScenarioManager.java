...
import cz.alois_seckar.vseadventrura.eu.pedu.adv16s_fw.Framework;
import cz.alois_seckar.vseadventrura.eu.pedu.adv16s_fw.empty_classes.EmptyGame;
...
import cz.alois_seckar.vseadventrura.eu.pedu.adv16s_fw.game_txt.IScenarioManager;
//import cz.alois_seckar.vseadventrura.eu.pedu.adv16s_fw.test_util.factorytest.FactoryTester;
//import cz.alois_seckar.vseadventrura.eu.pedu.adv16s_fw.test_util.gametxttests.TGameTester;
//import cz.alois_seckar.vseadventrura.eu.pedu.adv16s_fw.test_util.scenariotest.ScenarioManagerTester;
//import cz.alois_seckar.vseadventrura.eu.pedu.adv16s_fw.test_util.scenariotest.SMSummary;
...
import static cz.alois_seckar.vseadventrura.eu.pedu.adv16s_fw.utilities.ConditionalPrinter.*;
import static cz.alois_seckar.vseadventrura.eu.pedu.adv16s_fw.utilities.FormatStrings.*;
...
//== CONSTANT CLASS FIELDS =====================================================
    ...
    public static final Limits LIMITS = new Limits(
           10, //Minimal number of happy scenario steps
            6, //Minimal number of game spaces
            4, //Minimal number of visited spaces
...
//== OTHER NON-PRIVATE INSTANCE METHODS ========================================
    ...
    {
        verifySealed();
        return Stream.of(name2scenario.values());
    }
    ...
    protected final void addScenario(Scenario scenario)
    {
        ...
        ScenarioStep startStep = Stream.of(scenario)
    ...
    /***************************************************************************
     * Creates the crate with basic information about the associated game.
     * This information is obtained from the scenario manager and its scenarios.
     *
    ...
    public final SMSummary prepareSummary()
    {
        ...
        FactoryTester factoryTester = new FactoryTester(factoryClass);
        factoryTester.verify(FactoryTester.SCENARIO_MANAGER);
     ...
     * ie. according to the happy and mistake scenarios.
     */
    @Override
    public final void testGame()
    {
        //TGameTester tester = new TGameTester(factoryClass);
        //tester.testGame();
    }
    ...
    {
        //TGameTester tester = new TGameTester(factoryClass);
        //tester.testGameByScenarios(names);
    }
...
//== NESTED DATA TYPES =========================================================
     ...
     * @version 2016-Summer
     */
    private abstract static class ExtendingSM extends AScenarioManager
    {
