 ...
 * @version 2016-Summer
 */
public class Room extends AItemContainer implements ISpaceG
{
...
//== INSTANCE GETTERS AND SETTERS ==============================================
    ...
    {
        if (getName().equals(Texts.HALL)) {
            return new Point(8, 6);
        } else if (getName().equals(Texts.BEDROOM)) {
            return new Point(5, 2);
        } else if (getName().equals(Texts.LIVING_ROOM)) {
            return new Point(4, 6);
        } else if (getName().equals(Texts.BATHROOM)) {
            return new Point(9, 2);
        } else if (getName().equals(Texts.KITCHEN)) {
