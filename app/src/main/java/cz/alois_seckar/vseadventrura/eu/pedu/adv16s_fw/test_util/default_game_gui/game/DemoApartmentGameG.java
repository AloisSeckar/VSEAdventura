...
import cz.alois_seckar.vseadventrura.eu.pedu.adv16s_fw.game_gui.IListener;
 ...
 * @version 2016-Summer
 */
public class DemoApartmentGameG
     extends ANamed
    implements IGameG, IAuthorDemo
{
//== CONSTANT CLASS FIELDS =====================================================
    ...
    private static final DemoApartmentGameG SINGLETON = new DemoApartmentGameG();
...
//== CONSTRUCTORS AND FACTORY METHODS ==========================================
     ...
     */
    public static DemoApartmentGameG getInstance()
    {
        return SINGLETON;
    }
     ...
     */
    private DemoApartmentGameG()
    {
        super("Demo GUI game: An apartment with an intelligent ice-box");
    }
...
//== INSTANCE GETTERS AND SETTERS ==============================================
    ...
    {
        try {
            return new URL("http://rudolf.pecinovsky.cz/index.htm");
