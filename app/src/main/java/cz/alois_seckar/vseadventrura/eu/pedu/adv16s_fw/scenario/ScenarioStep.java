...
import cz.alois_seckar.vseadventrura.eu.pedu.adv16s_fw.utilities.Util;
...
import static cz.alois_seckar.vseadventrura.eu.pedu.adv16s_fw.utilities.Util.*;
...
//== PRIVATE AND AUXILIARY CLASS METHODS =======================================
     ...
     * @param space      The current space name after the command execution
     * @param neighbors  Name of the neighboring spaces
     * @param items      Names of the items in the current space
     ...
     * If the number is less then 10, it adds a space before the digit.
...
//== CONSTANT INSTANCE FIELDS ==================================================
    ...
    /** Current space after executing the command. */
    public final String space;

    /** Names of the neighboring spaces of the current space. */
    public final String[] neighbors;

    /** Names of items in the current space. */
...
//== CONSTRUCTORS AND FACTORY METHODS ==========================================
    ...
    public ScenarioStep(String command,  String message,  IGame game)
    {
        this(++lastIndex, TypeOfStep.tsNOT_SET, command, message,
             game.getWorld().getCurrentSpace().getName(),
             Util.colINamed2StringArr(
                     game.getWorld().getCurrentSpace().getNeighbors()),
             Util.colINamed2StringArr(
                     game.getWorld().getCurrentSpace().getItems()),
                        ...
                        String[] neighbors,  String[] items,  String[] bag)
    {
        this(++lastIndex, typeOfStep,
             command, message, space, neighbors, items, bag);
    }
    ...
    {
        this(++lastIndex, typeOfStep,
             command, message, space, neighbors, items, bag, theLast);
    }
    ...
    public ScenarioStep(int     index,      TypeOfStep typeOfStep,
                       ...
                       String[] neighbors,  String[] items,  String[] bag)
    {
        this(index, typeOfStep, command, message, space, neighbors, items,
             bag,   false);
    }
    ...
    public ScenarioStep(int index, ScenarioStep step, boolean theLast)
    {
        this(index, step.typeOfStep, step.command, step.message,
             step.space, step.neighbors,  step.items, step.bag, theLast);
    }
                       ...
                       boolean  theLast)
    {
        ...
        {
            String error =
                    "In scenario step constructing the exception was thrown " +
                    "caused by:\n" + errorMsg +  "\nEntered:";
...
//== OTHER NON-PRIVATE INSTANCE METHODS ========================================
    ...
    public boolean equals(Object obj)
    {
        ...
        if (this.command != null && !this.command.equals(other.command)) {
            return false;
        }
        if (this.message != null && !this.message.equals(other.message)) {
            return false;
        }
        if (this.space != null && !this.space.equals(other.space)) {
            return false;
        }
    ...
    public int hashCode()
    {
        ...
        if (this.typeOfStep != null) {
            hash = 97 * hash + (this.typeOfStep.hashCode());
        }
        if (this.command != null) {
            hash = 97 * hash + (this.command.hashCode());
        }
        if (this.message != null) {
            hash = 97 * hash + (this.message.hashCode());
        }
        if (this.space != null) {
            hash = 97 * hash + (this.space.hashCode());
        }
...
//== PRIVATE AND AUXILIARY INSTANCE METHODS ====================================
     ...
     * or string containing only the whitespaces.
    ...
    private boolean invalidMessage()
    {
            ...
            !invalidEmpty(type, message))
        {
            ...
            boolean  shortLines = Stream.of(lines)
    ...
    {
        String type = "Name of the named item (space or item)";
