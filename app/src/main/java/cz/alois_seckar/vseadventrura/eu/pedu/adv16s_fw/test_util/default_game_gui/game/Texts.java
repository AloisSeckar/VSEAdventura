...
//== CONSTANT CLASS FIELDS =====================================================
    ...
    static final String AUTHOR_NAME = "PECINOVSKÝ Rudolf";

    /** Author's ID (mostly login). */
    static final String AUTHOR_ID = "PECR999";
    ...
    mWELCOME_MSG =
          "Welcome in the official GUI apartment. You are surely hungry."
